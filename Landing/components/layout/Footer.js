                        ...
                        <div className="col-lg-4 width-23 mb-30">
                            <div className="mb-20">
                                <svg width="160" height="40" viewBox="0 0 160 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <text x="6" y="26" fontFamily="Arial" fontWeight="bold" fontSize="16" fill="white">S</text>
                                    <text x="38" y="27" fontFamily="Arial" fontWeight="800" fontSize="20" fill="white">SmartLogix</text>
                                </svg>
                            </div>
                            <p className="font-xs mb-20 color-white">SmartLogix es la plataforma todo-en-uno para pequeños comercios. POS, inventario, pedidos, despachos y dashboard en un solo lugar. Simplifica tu negocio, vende más.</p>
